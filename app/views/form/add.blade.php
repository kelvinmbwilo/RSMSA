...
<section class="panel panel-success">
   ...
   <div class="col-sm-12">
       ...
       <div class="alert alert-success fade in" role="alert">
           ...
           <strong>SUCCESS!</strong> Form {{ $form->name }} Added Successful.
       </div>
       @endif
<!--       <h3><a href="{{ url('location/levels') }}" class="btn btn-xs btn-info pull-right">Back to List</a></h3>-->
       <form class="form-horizontal" id="default" method="post" action="{{ url('form/add') }}">
           ...
           <div class="form-group">
               ...
               <div class="col-md-6">
                   {{ Form::select('data',array('0'=>'No Parent')+Data::orderBy('id','ASC')->get()->lists('name','id'),'',array('class'=>'form-control','required'=>'requiered')) }}
               </div>
           </div>
           <div class="form-group">

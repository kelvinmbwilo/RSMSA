                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" id="default">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                            <select name="select" class="form-control">
                                                ...
                                                <option>{{ $tbl->categoryName,  $tbl->id }}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                </div>
                            ...
                            <fieldset title="Step 2" class="step" id="default-step-1" >
                                <legend> </legend>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" id="DataCat"></label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" placeholder="Phone">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" id="DataC"></label>
                                    <div class="col-lg-10">
       ...
       /* $('#addColumn').click(function(){
        ...
        $('#default').stepy({
            ...
            select: function(index) {
                if(index == 2){
                    if($('select[name=select]').val() == "-- select one --"){
                        $('form').stepy('step', 1);
                        //$('select[name=select]').attr('name','Please Fill This Area First').focus()
                    }else{
                        //var ids = {{count($table)}};
                        //var aidis = new Array()
                        //aidis = {{ ($table) }};
                        //$my = aidis[2];
                        //$("#DataC").html($($my).val());
                        //$("#DataCat").html(("issy").val());
                        //$("#DataCat").html($('select[name=select]').val());
                        //$("#DataC").html($('h2[name=identity]').val());
                    }
                }
            }
        });

...
<section class="panel panel-success">
   ...
   <div class="col-sm-12">
       ...
       <div class="alert alert-success fade in" role="alert">
           ...
           <strong>SUCCESS!</strong>Field {{ $opt->name }} Added Successful.
       </div>
       @endif
<!--       <h3><a href="{{ url('location/levels') }}" class="btn btn-xs btn-info pull-right">Back to List</a></h3>-->
       <form class="form-horizontal" id="default" method="post" action="{{ url('option/add') }}">
           <div class="form-group">
               ...
               <div class="col-md-6">
                   <input type="text" class="form-control" placeholder="Field Name" name="option_name">
               </div>
           </div>
           <div class="form-group">
           ...
           <div class="form-group">
               <label class="col-md-2 control-label" id="DataCat"> Category Field(s)</label>
               <div class="col-md-6">
                   {{ Form::select('category_option[]',array('0'=>'No categories')+Categories::orderBy('id','ASC')->get()->lists('name','id'),array('0'),array('url'=>'posts',"id"=>"my-select",'class'=>'form-control','required'=>'requiered', 'multiple'=>'multiple')) }}
               <script>
